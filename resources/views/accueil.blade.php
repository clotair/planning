    ...
    @section('menu')
    	<div id="navbar" class="collapse navbar-collapse">
          	<ul class="nav navbar-nav">
				...
				<li><a class = "orientation" href="#"><span class ="glyphicon glyphicon-briefcase"></span> &nbsp;Evènement</a></li>
				
				
				<li>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class = "orientation" href="#"><span class ="glyphicon glyphicon-briefcase"></span> &nbsp;Connexion</a></li>
          	</ul>
        </div><!--/.nav-collapse -->
      	...
      	<div class="row">
          	<div class="col-lg-4">
            	<div class="col-lg-12">
              		...
              		<a class = "orientation" href="/salle"><button class="btn btn-primary"><span class="glyphicon glyphicon-ok-sign"></span> cliquer ici</button></a>
            	</div>
          	</div>
          	<div class="col-lg-4">
            	<div class="col-lg-12">
              		...
              		<a class = "orientation" href="/materiel"><button class="btn btn-primary"><span class="glyphicon glyphicon-ok-sign"></span> cliquer ici</button></a>
            	</div>
          	</div> 
          	<div class="col-lg-4">
            	<div class="col-lg-12">
              		...
              		<a class = "orientation" href="/enseignant"><button class="btn btn-primary"><span class="glyphicon glyphicon-ok-sign"></span> cliquer ici</button></a>
            	</div>
          	</div> 
       	</div>
    </div>
