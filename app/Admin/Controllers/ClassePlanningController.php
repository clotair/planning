...
class ClassePlanningController extends Controller
{
    ...
    {
        $grid = new Grid(new ClassePlanning);
    ...
    {
        $show = new Show(ClassePlanning::findOrFail($id));
    ...
    {
        $form = new Form(new ClassePlanning);
